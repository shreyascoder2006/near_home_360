...
function RecCard({ rec }: { rec: Recommendation }) {
  ...
  return (
    <div className={cn("flex w-[360px] shrink-0 flex-col rounded-lg border bg-void/60 p-3 transition-colors", rec.status === "pending" ? "border-stroke-lit" : "border-stroke opacity-60")} style={{ borderLeftColor: meta.color, borderLeftWidth: 2 }}>
